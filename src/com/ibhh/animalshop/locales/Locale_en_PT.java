...
public class Locale_en_PT extends PluginLocale implements PredefinedLocale
{

	public Locale_en_PT(String path)
	{
		super("en_PT", Localizer.getByCode("en_PT").getName());
		createFile(path);
	}
	...
	public void createFile(String path)
	{
		...
		addDefault("configuration.language.pathnotfound", "Wo couldn't find in the \"language.%s.yml\" the path \"%s\"! The default language is used: ");
		addDefault("configuration.language.languagenotfound", "Language \"%s\" does not exist for YOU! Arrrrrrrrr");
		addDefault("configuration.language.list", "Other devil languages are: ");
		addDefault("configuration.language.listhover", "Click to change!");
		
		addDefault("help.head", "AnimalShop Help ");
		addDefault("help.commandsallowed", "You can run those commands:");

		addDefault("permission.error", "we have a problem! You're dump!");
